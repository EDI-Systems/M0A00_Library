...
This **lsm303agr** MCU component repository is one element **common to all** STM32Cube MCU embedded software packages, providing the **LSM303AGR** BSP MEMS component part.
...
Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/lsm303agr/blob/main/Release_Notes.html).
...
If you have any issue with the **software content** of this repository, you can file an issue [here](https://github.com/STMicroelectronics/lsm303agr/issues/new/choose).
